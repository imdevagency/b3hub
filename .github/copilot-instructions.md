...
- `(buyer)` — business, catalog, certificates, disputes, documents, field-passes, framework-contract/, framework-contracts, home, invoices, new-order, order/, orders, profile, project/, projects, rfq/, saved-addresses, schedules, skip-order/, team, transport-job/
