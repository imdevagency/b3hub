...
- **Buyers** — construction companies, contractors, homeowners ordering materials, transport, or waste disposal
...
| `projects`              | `/api/v1/projects/*`              | ❌ Removed from scope                                                                                                           |
| `provider-applications` | `/api/v1/provider-applications/*` | Seller/carrier onboarding applications                                                                                          |
| `quote-requests`        | `/api/v1/quote-requests/*`        | ❌ Removed from scope                                                                                                           |
...
| `skip-hire`             | `/api/v1/skip-hire/*`             | ❌ Removed from scope                                                                                                           |
...
apps/web/src/app/
  ...
  dashboard/               — authenticated portal (sidebar layout)
    ...
    ...                    — shared: orders, jobs, support-chat, notifications, settings
...
app/
  ...
  (buyer)/    — home, catalog, orders, transport-job, account sub-group, framework-contracts
  (driver)/   — home, jobs, active, earnings, schedule, vehicles, documents
  (seller)/   — home, incoming, catalog, earnings, documents, framework-contracts
  (recycler)/ — home, incoming, records, documents
  (shared)/   — settings, notifications, support-chat, help, delivery-proof, reviews, change-password
  (wizards)/  — material-order, transport, disposal, utilization
...
1. Public wizard (materials / transport / disposal)
