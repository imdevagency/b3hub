...
| **Carrier**  | Trucking companies, independent drivers         | Accept and execute transport jobs and container hire jobs — with earnings and documentation |
| **Recycler** | Licensed waste processing facilities            | Receive booked waste jobs and issue legally compliant certificates                          |

All four sides share a single platform. A company can be a seller **and** a carrier (HYBRID). A construction company is a buyer that may also submit its own drivers as carriers. The roles are not mutually exclusive; the scope boundaries are.
...
| Place orders: materials delivery, transport-only, disposal, skip hire, container hire, toilet cabin hire | Multi-type support                                              |
...
| Skip hire and container hire job queue                                                     | Same driver app, gated by `canSkipHire`        |
| Toilet cabin hire job queue                                                                | Same driver app, gated by `canSkipHire`        |
...
| Out of scope                                                             | Who owns it instead            |
| ------------------------------------------------------------------------ | ------------------------------ |
| Recycling process management (how waste is sorted, processed, resold)    | Recycler's internal operations |
...
- Approve / reject provider applications (sellers, carriers, recyclers)
