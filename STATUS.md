...
| [ARCHITECTURE.md](ARCHITECTURE.md) | ✅ Updated — payment section now reflects Paysera (redirect checkout + webhook) with Stripe Connect noted only for solo individual driver payouts.                                                                                                                                                                                                                            |
