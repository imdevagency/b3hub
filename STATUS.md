...
| **Skip Hire** _(removed)_            | —                                    | —                                                                                                                                                                                                                             | —                                        | Removed from Bilt scope. Backend module, DB models, mobile screens, and web wizards deleted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| **Toilet Cabin Rental** _(removed)_  | —                                    | —                                                                                                                                                                                                                             | —                                        | Removed from Bilt scope.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                          |
| **Quote Requests (RFQ)** _(removed)_ | —                                    | —                                                                                                                                                                                                                             | —                                        | Removed from Bilt scope. Backend module and DB models deleted; mobile rfq screens deleted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| **Projects** _(removed)_             | —                                    | —                                                                                                                                                                                                                             | —                                        | Replaced by Framework Contracts. DB models and all references deleted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| **Carrier Settings**                 | ✅ `carrier-settings/`               | ✅ `/dashboard/transporter/settings`                                                                                                                                                                                          | 📵                                       | Carrier pricing, service zones, availability. Dispatcher triage panel (SLA kavējumi, atvērtie izņēmumi) on `/dashboard/transporter`                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| **Chat / Support**                   | ✅ `chat/`, `support/`               | ✅ `/dashboard/chat` (Bilt contact info + notification links)                                                                                                                                                                 | ✅ `support-chat`, `messages`            | Bilt↔user support threads only. No P2P. `chat/[jobId]` redirects to `support-chat`. `messages` tab shows Bilt system comms.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       |
...
| **B2C — Guest checkout**             | ✅ Done                              | ✅ `WebWizardAuthGate` updated — choice screen shows "Turpināt kā viesis" as primary CTA; guest form (name + phone + optional email) submits to `POST /api/v1/guest-orders`; redirects to `/pasutījums/[token]` tracking page | 📵                                       | Backend: `GuestOrdersModule` (service + controller + DTO). `MaterialOrderWizard`, `TransportWizard`, `DisposalWizard` wired. Confirmation email sent via `sendGuestOrderConfirmation()`. Public tracking page at `/pasutījums/[token]`. Admin can update status + link to real order on conversion.                                                                                                                                                                                                                                                                                                               |
...
| **Skip hire, toilet cabins, quote requests (RFQ), and projects removed** — all four modules deleted from DB schema, backend services, mobile screens, and web wizards/pages. `SkipHireOrder`, `ToiletCabinOrder`, `QuoteRequest`, `Project` models gone. Enums cleaned. Mobile wizard directories, API functions, and navigation references removed. Web `SkipHireWizard`, `ToiletCabinWizard` deleted; admin RFQ nav tab removed; buyer dashboard skip-hire tile removed. | ✅     | Backend + Web + Mobile |
