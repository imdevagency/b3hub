...
function LoginPage() {
    ...
    const onSubmit = async (data)=>{
        setError(null);
        try {
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$web$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["loginUser"])(data);
...
_s(LoginPage, "S5CK+hTI+IqxkxNk48sNcHlLsrg=", false, function() {
    return [
...
//# sourceMappingURL=apps_web_src_ae93e76f._.js.map