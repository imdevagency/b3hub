...
const startIndex = txt.indexOf('<div className="flex items-center gap-1 overflow-x-auto pb-3 pt-1 scrollbar-none snap-x relative mask-fade-edges">');
...
if (startIndex !== -1 && endIndex !== -1) {
  ...
  console.log("Success with node replace 5");
} else {
  console.log("Could not find start/end marks", startIndex, endIndex);
}
