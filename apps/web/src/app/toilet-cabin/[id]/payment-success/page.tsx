/**
 * Payment success landing page — /toilet-cabin/[id]/payment-success
 * Paysera redirects here after a successful toilet-cabin order payment.
 */
'use client';
...
export default function ToiletCabinPaymentSuccessPage() {
        ...
        <CardContent className="pt-8 pb-8 flex flex-col items-center text-center gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm">
              Jūsu tualetes kabīnes pasūtījums ir apstiprināts. Pārvadātājs drīzumā sazināsies par
              piegādes laiku.
            </p>
          </div>
