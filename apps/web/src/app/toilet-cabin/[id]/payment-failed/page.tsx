/**
 * Payment failure landing page — /toilet-cabin/[id]/payment-failed
 * Paysera redirects here when a toilet-cabin payment attempt is cancelled or fails.
 */
'use client';
...
export default function ToiletCabinPaymentFailedPage() {
