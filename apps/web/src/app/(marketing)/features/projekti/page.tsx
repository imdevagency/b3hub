...
export default function ProjektiPage() {
 ...
 <span className="text-xs font-bold tracking-wide uppercase px-2 py-1">
 Aktīvs
 </span>
 </div>
 {/* Progress */}
 ...
 <div className="relative w-full h-1.5 bg-">
 <div
 ...
 {/* Stats row */}
 <div className="grid grid-cols-3 gap-4 mt-4 pt-4 text-xs">
 {[
 { v: '5', l: 'Izsaukumi' },
 { v: '12', l: 'Piegādes' },
 { v: '€11 200', l: 'Kopā' },
 ...
 <div className="w-16 h-0.5 bg- mt-1.5 ml-auto">
 <div
 ...
 <div className="relative w-full h-2 bg-">
 <div
 ...
 <div className="bg-neutral-50 rounded-2xl p-4 text-xs flex items-start gap-3">
