...
export default function GpsIzsekosanaPage() {
 ...
 <div className="bg-background bg-neutral-50 rounded-2xl px-2.5 py-1 text-xs font-medium shadow-sm whitespace-nowrap">
 ~18 minūtes
 </div>
 </div>
 {/* Origin dot */}
 ...
 <div className="relative w-full h-px bg-">
 ...
 <div
 key={time}
 className="flex items-start gap-3 bg-neutral-50 rounded-2xl px-4 py-3 text-xs"
 >
