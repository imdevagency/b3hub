...
const benefits = [
  {
    icon: Trash2,
    title: 'Pieprasījums vienā solī',
    body: 'Piesakies atkritumu izvešanai tieši lietotnē. Norādi adresi, atkritumu veidu un daudzumu — Bilt organizē pārvadātāju un izvēlas tuvāko pieņemšanas centru.',
  },
  {
    icon: MapPin,
