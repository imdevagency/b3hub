/**
 * Payment success landing page — /order/[id]/payment-success
 * Paysera redirects the buyer here after a successful payment.
 * Webhook has already (or is about to) update the order status in the DB.
 */
'use client';
...
export default function OrderPaymentSuccessPage() {
  ...
  // Auto-redirect to order detail after a short delay
  useEffect(() => {
        ...
        <CardContent className="pt-8 pb-8 flex flex-col items-center text-center gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <p className="text-muted-foreground text-sm">
              Jūsu maksājums ir saņemts. Pasūtījums tiek apstrādāts — piegādātājs drīzumā
              apstiprinās iekraušanu.
            </p>
          </div>
