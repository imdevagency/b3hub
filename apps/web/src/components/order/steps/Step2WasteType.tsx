...
const WASTE_TYPES: WasteType[] = [
  {
    id: 'mixed',
    label: 'Jaukti Atkritumi',
    description: 'Vispiringī mājsaimniecības un komerciālie atkritumi',
    icon: Trash2,
  ...
  },
  {
    id: 'rubble',
    label: 'Betona Gruži',
    description: 'Kķieģeļi, flīzes, betons, augsne',
    icon: HardHat,
  ...
  },
  {
    id: 'wood',
    label: 'Koks',
    description: 'Koks, mēbeles, paletes',
    icon: Trees,
  ...
  },
  {
    id: 'metal',
    label: 'Metāls / Lūžņi',
    description: 'Tērauds, alumīnijs, caurules',
    icon: Package,
    color: 'bg-blue-100 text-blue-600 border-blue-200',
  },
  {
    id: 'electronics',
    label: 'Elektronika (WEEE)',
    description: 'Sadzīves tehnika, kabeļi, IT iekārtas',
    icon: Cpu,
  ...
  return (
    <div className="flex flex-col space-y-8">
      ...
      <div className="text-center space-y-2">
        <h2 className="text-2xl font-bold text-gray-900">Kāds atkritumu veids?</h2>
        <p className="text-gray-500">
          Izvēlieties kategoriju, kas vislabāk raksturo jūsu atkritumus.
        </p>
      </div>
