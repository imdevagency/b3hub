        ...
        <div className="xl:grid xl:grid-cols-2 xl:gap-8">
          ...
          <div className="space-y-6 xl:col-span-1">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              <span
                className="inline-flex items-center gap-3 bg-neutral-200/50 px-5 py-3 border border-neutral-300 opacity-60 cursor-not-allowed rounded-full"
              ...
              >
                ...
                <div className="flex flex-col leading-tight">
                  <span className="text-foreground/60 text-xs">Drīzumā</span>
          ...
          <div className="mt-16 grid grid-cols-2 md:grid-cols-4 gap-10 xl:col-span-1 xl:mt-0">
            <div>
              <h3 className="text-lg font-medium text-foreground tracking-tight mb-6">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground tracking-tight mb-6">Platforma</h3>
              <ul role="list" className="space-y-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground tracking-tight mb-6">Uzņēmums</h3>
              <ul role="list" className="space-y-3">
            ...
            <div>
              <h3 className="text-lg font-medium text-foreground tracking-tight mb-6">Juridiski</h3>
              <ul role="list" className="space-y-3">
