...
import { MapPin, Truck, Calendar, Weight, ArrowRight } from 'lucide-react-native';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      Alert.alert(
        ...
        `Jūsu transporta pieprasījums ir reģistrēts.\nNumurs: ${result?.jobNumber ?? '—'}`,
...
const s = StyleSheet.create({
  ...
  dateStepDisabled: { borderColor: '#f3f4f6', backgroundColor: '#f9fafb' },
  dateStepIcon: { fontSize: 22, color: '#374151', lineHeight: 26 },
  dateCenter: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 8,
