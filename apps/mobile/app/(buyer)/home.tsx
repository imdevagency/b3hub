...
const s = StyleSheet.create({
  ...
  greetLabel: { fontSize: 12, color: '#9ca3af', fontWeight: '500', lineHeight: 17 },
  greetName: { fontSize: 17, fontWeight: '800', color: '#111827', lineHeight: 23 },
  bellBtn: {
    width: 42,
    height: 42,
    borderRadius: 21,
  ...
  seeAll: { fontSize: 13, fontWeight: '600', color: '#374151' },

  // Active order — solid black card
  activeCard: {
    flexDirection: 'row',
    alignItems: 'center',
    gap: 14,
  ...
  activeTag: { fontSize: 11, color: '#6b7280', fontWeight: '500', marginBottom: 3 },
  activeNum: { fontSize: 17, fontWeight: '800', color: '#fff', lineHeight: 22 },
  activeSub: { fontSize: 12, color: '#6b7280', marginTop: 3 },
  activeArrow: {
    width: 30,
    height: 30,
    borderRadius: 15,
  ...
  serviceLabel: { fontSize: 14, fontWeight: '700', color: '#111827', lineHeight: 19 },
  serviceSub: { fontSize: 12, color: '#9ca3af', lineHeight: 17 },
  ...
  recentBorder: { borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: '#f3f4f6' },
  recentIconBox: {
    width: 34,
    height: 34,
    borderRadius: 10,
  ...
  recentNum: { fontSize: 13, fontWeight: '600', color: '#111827', lineHeight: 18 },
  recentSub: { fontSize: 12, color: '#9ca3af', lineHeight: 17, marginTop: 1 },
  ...
  allBtnText: { fontSize: 14, fontWeight: '600', color: '#374151' },
