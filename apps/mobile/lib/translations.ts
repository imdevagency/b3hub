...
export const lv = {
  ...
  skipHire: {
    ...
    step2: {
      ...
      next: 'Turpināt',
      types: {
        MIXED: { label: 'Būvgružu konteineru noma', desc: 'Jaukti būvniecības atkritumi', emoji: '📦' },
        CONCRETE_RUBBLE: { label: 'Tīri būvgruži', desc: 'Betona gabali, ķieģeļi, fīlas', emoji: '🧱' },
        WOOD: { label: 'Koka atkritumi', desc: 'Būvkoks, pales, brus', emoji: '🪵' },
...
export const ru: Translations = {
  ...
  skipHire: {
    ...
    step2: {
      ...
      next: 'Продолжить',
      types: {
        MIXED: { label: 'Аренда контейнера для строительного мусора', desc: 'Смешанные строительные отходы', emoji: '📦' },
        CONCRETE_RUBBLE: { label: 'Чистый строительный мусор', desc: 'Бетон, кирпич, плитка', emoji: '🧱' },
        WOOD: { label: 'Древесные отходы', desc: 'Строительная древесина, поддоны', emoji: '🪵' },
      } as Record<string, { label: string; desc: string; emoji: string }>,
    },
    step3: {
  ...
  carrierSkips: {
    ...
    wasteTypes: {
      MIXED: 'Аренда контейнера',
      CONCRETE_RUBBLE: 'Чистый строительный мусор',
      WOOD: 'Древесные отходы',
      GREEN_GARDEN: 'Прочее',
      METAL_SCRAP: 'Прочее',
      ELECTRONICS_WEEE: 'Прочее',
    } as Record<string, string>,
  },
